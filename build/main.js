...
var getBody = __webpack_require__(48)
var iconv = __webpack_require__(75)
var onFinished = __webpack_require__(93)
var zlib = __webpack_require__(95)
...
var mime = __webpack_require__(97)
...
var callSiteToString = __webpack_require__(15).callSiteToString
var eventListenerCount = __webpack_require__(15).eventListenerCount
...
lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
  ...
  return stack[0].toString ? toString : __webpack_require__(36)
})

lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount () {
  return EventEmitter.listenerCount || __webpack_require__(37)
})
...
lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
  ...
  return stack[0].toString ? toString : __webpack_require__(51)
})

lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount () {
  return EventEmitter.listenerCount || __webpack_require__(52)
})
...
/* WEBPACK VAR INJECTION */(function(__dirname) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(34);
...
const { Nuxt, Builder } = __webpack_require__(107);
let config = __webpack_require__(108);
const routes = __webpack_require__(109);
const fs = __webpack_require__(20);
const bootStarpVue = 'bootstrap-vue';

__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].use(bootStarpVue);
...
var iconv = __webpack_require__(56)
var unpipe = __webpack_require__(74)
...
var deprecate = __webpack_require__(50)('http-errors')
...
var codes = __webpack_require__(55)
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(13).concat(__webpack_require__(23)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(13).concat(__webpack_require__(23)) },
        gb18030: function() { return __webpack_require__(69) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(24).concat(__webpack_require__(71)) },
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(14).concat(__webpack_require__(25)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(14).concat(__webpack_require__(25)) },
        gb18030: function() { return __webpack_require__(88) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(26).concat(__webpack_require__(90)) },
        encodeSkipVals: [0xa2cc],
    },
...
var first = __webpack_require__(94)
...
var stringify = __webpack_require__(104);
...
module.exports = {
  ...
  */
  head: {
    title: 'demoshop',
    meta: [{ charset: 'utf-8' }, { name: 'viewport', content: 'width=device-width, initial-scale=1' }, { hid: 'description', name: 'description', content: 'demosite' }],
...
const admin = __webpack_require__(110);
const goods = __webpack_require__(113);
const purchase = __webpack_require__(114);
const users = __webpack_require__(115);
...
const goods = __webpack_require__(29);
const file = __webpack_require__(111);
...
router.get('/purchase', (req, res) => {
    ...
    orders.find().select({}).limit(limit).skip(offset).exec(function (err, order) {
...
router.get('/users', (req, res) => {
    ...
    let limit = 5;
    let offset = page * limit;
    users.find().select({}).limit(limit).skip(offset).exec(function (err, user) {
...
router.get('/goods', (req, res) => {
    ...
    goods.find().select({}).limit(limit).skip(offset).exec(function (err, good) {
...
/* WEBPACK VAR INJECTION */(function(__dirname) {const multer = __webpack_require__(112);
...
/* WEBPACK VAR INJECTION */}.call(exports, "server\\utils\\fileUpload"))
...
router.get('/detail', (req, res) => {
    ...
    goods.findOne({ '_id': id }).then(result => {
        res.json(result);
    });
});
...
router.post('/signup', (req, res, next) => {
    ...
    user.status = 1;
    users.findOne({ 'uid': user.uid }).then(result => {
        if (!result) {
...
module.exports = new LocalStrategy({
    ...
    .then(result => {
        if (!result) {
            console.log("fail to sign in");done(null, false);
        } else {
